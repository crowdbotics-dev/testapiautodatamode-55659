...
## Project Structure
    ...
    ├── testapiautodatamode_55659  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_55659`
...
2. Clone this repo and `cd testapiautodatamode_55659`
